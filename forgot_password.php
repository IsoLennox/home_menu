...
$formcontent=" \r\n You have requested a password reset on Home Menu. \r\n Go to Home Menu to reset your password for ' $username ':\r\nhttp://http://portland.radiotown.com/KB/reset_password.php?user_id=".$user_id."&token=".time()."\r\nThis link will be good for one hour.";
$subject = "Password Reset On Home Menu";
